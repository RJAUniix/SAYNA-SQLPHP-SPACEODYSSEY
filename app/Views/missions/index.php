            ...
            if ($cardCount < 2) {
                ...
                <div class="col-lg-6">
                    <div class="card mb-3 bg-dark text-light">
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title mb-3"><b>'. $row['nom'] .'</b></h5>';
                                
                                    // Ajout du badge en haut à droite si la personne est disponible
                                    // Pour avoir le statut de la mission
                                    $dateActuelle = new DateTime();
                                    $dateDebut = new DateTime($row['debut']);
                                    $comparisonResult = $dateDebut->compare($dateActuelle);
